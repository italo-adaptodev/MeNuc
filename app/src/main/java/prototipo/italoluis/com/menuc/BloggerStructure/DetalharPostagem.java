...
public class DetalharPostagem extends AppCompatActivity {
  ...
  public static final String QUESTIONARIOIFBA_BLOGSPOT_COM = "questionarioifba.blogspot.com";
  public static final String DOCS_GOOGLE_COM = "forms.gle";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    webView.setWebViewClient(new WebViewClient(){
      ...
      public boolean shouldOverrideUrlLoading(WebView view, String url)
      {
        ...
        if (MENUCEDUCADIONAL_BLOGSPOT_COM.equals(host) || QUESTIONARIOIFBA_BLOGSPOT_COM.equals(host)){
          return false;
        }
